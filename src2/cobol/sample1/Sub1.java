...
public class Sub1 {
    ...
    // 01 SUB-WORK-AREA — WORKING-STORAGE（SUB1 プログラム固有）
    // 03 SUB-WORK-DATA PIC X(10)
    private static String subWorkData = "          ";
    ...
    public static void call(HogeDate paramDate) {
        ...
        // DISPLAY "  SUB1: SUB-WORK-DATA: " SUB-WORK-DATA（MOVE 前）
        CobolUtil.display("  SUB1: SUB-WORK-DATA: ", subWorkData);

        // MOVE "SUB-DATA" TO SUB-WORK-DATA
        subWorkData = CobolUtil.move("SUB-DATA", 10);

        // DISPLAY "  SUB1: SUB-WORK-DATA: " SUB-WORK-DATA（MOVE 後）
        CobolUtil.display("  SUB1: SUB-WORK-DATA: ", subWorkData);
